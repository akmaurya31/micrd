...
<div id="sideDrawer" class="fixed top-0 right-0 h-full w-full max-w-[550px] bg-white shadow-2xl z-50 transform translate-x-full transition-transform duration-300 ease-in-out flex flex-col">
    <div class="flex items-center justify-between px-6 py-4 bg-slate-50 border-b border-gray-200">
        <h2 class="text-[#1e3e62] font-semibold text-lg">Create SiteReadiness</h2>
    ...
    <form id="readinessForm" enctype="multipart/form-data" class="flex-1 overflow-y-auto p-6 space-y-4 text-sm text-gray-700">
        ...
        <div>
            <label class="block font-medium mb-1">Select Type <span class="text-red-500">*</span></label>
            <select id="userType" name="user_type" required class="w-full border border-blue-100 bg-[#f4f9fd] rounded px-3 py-2 focus:outline-none focus:border-blue-400">
                <option value="">--Select--</option>
                <option value="HM">HM (HeadMaster)</option>
                <option value="BO">BO</option>
                <option value="BSA">BSA (Basic Shiksha Adhikari)</option>
            </select>
        </div>
        ...
        <div>
            ...
            <div class="flex items-center space-x-6 mt-2">
                <label class="inline-flex items-center cursor-pointer">
                    <input type="radio" name="status" value="Approve" required class="text-[#004e92] focus:ring-[#004e92]">
                    <span class="ml-2 text-gray-700">Approve</span>
                </label>
                <label class="inline-flex items-center cursor-pointer">
                    <input type="radio" name="status" value="Pending" class="text-[#004e92] focus:ring-[#004e92]">
                    <span class="ml-2 text-gray-700">Pending</span>
                </label>
                <label id="snrOption" class="hidden items-center cursor-pointer">
                    <input type="radio" name="status" value="SNR" class="text-[#004e92] focus:ring-[#004e92]">
                    <span class="ml-2 text-gray-700">SNR</span>
                </label>
            </div>
        </div>
