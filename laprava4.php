...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* --- Hero Section - Replicated Layout from image_979c06.png --- */
        .hero {
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        /* Split-Asymmetric Box Framework from image_979c06.png */
        .hero-visual-pane {
            position: relative;
            display: flex;
        ...
        /* --- Impact Manifesto Grid (image_979c06.png Sub-Hero Content) --- */
        .manifesto-bar {
            background: #0b0c0f;
        ...
        /* High-Utility Operations Background variant */
        .ops-panel-bg {
            background: #090a0d;
        ...
        /* --- Dual Segment Layout from image_979c06.png Bottom Content --- */
...
<body>
    ...
    <!-- Custom High-Impact Hero Segment -->
    <section id="home" class="hero">
        <div class="hero-container">
            <div class="hero-info-pane">
                ...
                <a href="#architecture" class="pill-btn">
                    View Portfolio <i class="fa-solid fa-arrow-right-long"></i>
                </a>
            </div>
            
            <div class="hero-visual-pane">
                <!-- Asymmetric container style sourced from image_979c06.png Layout -->
    ...
    <!-- Content Manifesto Block from image_979c06.png Vibe -->
    ...
    <!-- Operations & Government Network Base -->
    ...
    <section id="studio">
        ...
        <!-- Custom Metric Component based directly on image_979c06.png Bottom Layout -->
